...
public class EnumStringUserType extends EnumType {

	public static final String NAME = "net.jazgung.hibernate.user_type.enum_type.EnumStringUserType";
	...
	public static void main(String[] args) {
		System.out.println(EnumStringUserType.class.getName());
	}
