...
@Entity(name = "performance_fetch_to_one_join_fetch_car")
@Table(name = "performance_fetch_to_one_join_fetch_car")
public class ToOneJoinFetchCar extends AbstractEntity {
