...
@Entity(name = "performance_fetch_to_one_default_fetch_car")
@Table(name = "performance_fetch_to_one_default_fetch_car")
public class ToOneDefaultFetchCar extends AbstractEntity {
